...
${TESTDIR}/testclassTantQueunit.o: testclassTantQueunit.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testclassTantQueunit.o testclassTantQueunit.cpp


${TESTDIR}/testrunnerTantQueunit.o: testrunnerTantQueunit.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testrunnerTantQueunit.o testrunnerTantQueunit.cpp
