...
${TESTDIR}/testclasstantque.o: testclasstantque.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testclasstantque.o testclasstantque.cpp


${TESTDIR}/testrunnertantque.o: testrunnertantque.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/testrunnertantque.o testrunnertantque.cpp
